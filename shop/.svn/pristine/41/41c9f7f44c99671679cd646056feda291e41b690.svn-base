...
$(document).ready(function() {
   ...
   function board_search(currentPage) {
      ...
      currentPage = currentPage || 1;
         ...
         callAjax("/commu/BoardList.do", "post", "text", true, param, resultCallback);
   }
   ...
   function freeboardDtl(wno) {
      
      fSelectBoardDtl(wno);
   }
   
   function fSelectBoardDtl(wno) {
      ...
      callAjax("/commu/selectBoard.do", "post", "json", true, param, BoardResultCallback);
   }
               ...
               <div class="content">
                  ...
                  <p class="Location">
                     <a href="#" class="btn_set home">메인으로</a> <a href="#"
                        class="btn_nav">자료실</a> <span class="btn_nav bold">자유게시판
                        </span> <a href="#" class="btn_set refresh">새로고침</a>
                  </p>
                  
                  <p class="conTitle">
                     <span>자유게시판 </span> <span class="fr"><a class="btnType blue" href="javascript:fBoardReg();" name="modal"><span>글쓰기</span></a>
         ...
         <dd class="content">            
            ...
            <table class="row">
               ...
               <tbody>                  
                  ...
                  <tr>
                     <th scope="row">작성자</th>
                     <td><input type="text" id="writer" name="writer" disabled></td>
                  </tr>                  
