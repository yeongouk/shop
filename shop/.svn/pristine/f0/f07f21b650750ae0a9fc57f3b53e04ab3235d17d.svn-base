package kr.kosmo.jobkorea.stats.dto;

import org.apache.ibatis.type.Alias;

@Alias("StatsDTO2")
public class StatsDTO2 {
	...
	public StatsDTO2(String boardNum, String editor, String content, String title, String workarea, String work_type, String industry_type, String project_name, String reg_date,
	...
	public String toString() {
		return "AdmProjectDTO [boardNum = " + boardNum + ", editor=" + editor + ", content = " + content + ", title =" + title + ", workarea=" + workarea + ", work_type=" + work_type + ", industry_type=" + industry_type
