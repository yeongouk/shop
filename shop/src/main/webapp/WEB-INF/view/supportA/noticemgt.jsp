...
//alert("지금 현재 페이지를 찍어봅시다. " + currentPage);
		...
		callAjax("/supportA/noticeList.do","post","text", true, param, resultCallback);
	...
	function fOnloadImg(param){
	 ...
	 function fdetailModal(nt_no){
		 ...
		 callAjax("/supportA/detailNoticeList.do", "post", "json", true, param, resultCallback2);
		 //alert("공지사항 상세 조회  22");
	 }
	 ...
	 function fSaveNotice(){
		 ...
		 callAjax("/supportA/noticeSave.do", "post", "json", true, $("#myNotice").serialize(), resultCallback3);
