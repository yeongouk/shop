...
$(document).ready(function() {
	...
	function ctmSpecProCostList(currentPage) {
		...
		callAjax("/stats/ctmSpecProCostList.do", "post", "text", true, param, resultCallback);
	}
	
	function fBoardResult(data, currentPage) {
		
		
		$('#ctmSpecProCostList').empty();
		...
		var $ctmSpecProCostList = $data.find("#ctmSpecProCostList");
		$("#ctmSpecProCostList").append($ctmSpecProCostList.children());
		
		
		var $totalCnt = $data.find("#totalCnt");
		var totalCnt = $totalCnt.text();
		
		var paginationHtml = getPaginationHtml(currentPage, totalCnt, PageSize, PageBlock, 'ctmSpecProCostList'); 
					...
					<div class="content">
						...
						<p class="Location">
							...
							<a href="#" class="btn_nav">통계</a> 
								<span class="btn_nav bold">특정 상품의 일정 금액 이상 주문한 고객 목록</span> 
								<a href="#" class="btn_set refresh">새로고침</a>
						</p>

						<p class="conTitle">
							<span>특정 상품의 일정 금액 이상 주문한 고객 목록 </span> <br>
							<span class="fr" >-Event 짜파게티 구매 금액 10000원/ 콜라 5000원 구매 고객 목록</span>
						</p>
