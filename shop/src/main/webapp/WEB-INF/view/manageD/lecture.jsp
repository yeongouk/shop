...
<script type="text/javascript">
	...
	function fInitFormGrp(object) {
		...
		if( object == "" || object == null || object == undefined) {
			...
			$("#grp_lec_title").val(object.grp_lec_title);
			$("#grp_user_teacherName").val(object.grp_user_teacherName);
			$("#grp_lec_startDate").val(object.grp_lec_startDate);
			$("#grp_lec_endDate").val(object.grp_lec_endDate);
			$("#grp_lec_plan").text(object.grp_lec_plan); // textarea
			$("#grp_pro_processRate").val(object.grp_pro_processRate);
			$("#grp_lec_attend").val(object.grp_lec_attend);
			$("#grp_lec_lateness").val(object.grp_lec_lateness);
			$("#grp_lec_absent").val(object.grp_lec_absent);
	...
	/** 수강목록/진도 모달 실행 */
	function fPopModalLectureGrp(lec_no) {
	...
	function fListLectureGrp(currentPage) {
		...
		callAjax("/manageD/listLectureGrp.do", "post", "text", true, param, resultCallback);
	...
	function fSelectGrp(lec_no) {
		...
		callAjax("/manageD/selectLectureGrp.do", "post", "json", true, param, resultCallback);
	}
	...
	function fSaveGrp() {
		...
		callAjax("/manageD/saveLectureGrp.do", "post", "json", true, $("#myForm").serialize(), resultCallback);
	}
							...
							<tr class="search">
								<th scope="row">
									<SELECT id="type">
										...
										<OPTION value="plan">강의내용</OPTION>
									</SELECT>
								</th>
								<td class="keyword"><input type="text" name="keyword" id="keyword"/></td>
								<th class="title" scope="row">날짜</th>
								<td class="inputDate"><input type="date" name="startDate" id="startDate">&nbsp;&nbsp;~&nbsp;&nbsp;<input type="date" name="endDate" id="endDate"></td>
								<td><a class="btnType blue searchBtn" href="javascript:fListLectureGrp();" name="modal"><span>검색</span></a></td>
							</tr>
						</table>
			...
			<dd class="content">
				...
				<table class="row">
					...
					<tbody>
						...
						<tr>
							<td colspan="2"><input type="text" class="inputTxt p100" name="grp_lec_title" id="grp_lec_title" /></td>
							<td colspan="2"><input type="text" class="inputTxt p100" name="grp_user_teacherName" id="grp_user_teacherName" /></td>
							<td colspan="2">
								<input type="date" name="grp_lec_startDate" id="grp_lec_startDate">
								&nbsp;&nbsp;~&nbsp;&nbsp;
								<input type="date" name="grp_lec_endDate" id="grp_lec_endDate">
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="6"><textarea class="inputTxt p100" name="grp_lec_plan" id="grp_lec_plan" style="resize:none;"></textarea></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2"><input type="text" class="inputTxt p100"
								name="grp_pro_processRate" id="grp_pro_processRate" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2"><input type="text" class="inputTxt p100" name="grp_lec_attend" id="grp_lec_attend" /></td>
							<td colspan="2"><input type="text" class="inputTxt p100" name="grp_lec_lateness" id="grp_lec_lateness" /></td>
							<td colspan="2"><input type="text" class="inputTxt p100" name="grp_lec_absent" id="grp_lec_absent" /></td>
						</tr>
					</tbody>
				</table>
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType blue" id="btnSaveGrp" name="btn"><span>저장</span></a> 
					<a href=""	class="btnType gray"  id="btnCloseGrp" name="btn"><span>취소</span></a>
				</div>
			</dd>
		</dl>
